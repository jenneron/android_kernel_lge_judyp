...
#define IDTP9222_CURRENT_MA_MAX		1000
...
static int psy_get_power(struct idtp9222_struct* idtp9222) {
	...
	if (idtp9222_is_onpad(idtp9222)) {
		int voltage_mv = idtp9222->opmode_midpower ? IDTP9222_VOLTAGE_MV_EPP : IDTP9222_VOLTAGE_MV_BPP;
		int current_ma = IDTP9222_CURRENT_MA_MAX;
