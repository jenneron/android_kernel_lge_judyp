...
int set_fsc_wled(struct qpnp_wled *wled)
{
	int i, rc  = 0;
	u8 reg = 0;
	u16 data = 0;

	data = wled->fs_curr_ua;
...
#if IS_ENABLED(CONFIG_LGE_DISPLAY_USE_FSC)
	if ((level <= low_limit) && (wled->fs_curr_ua == LGE_WLED_AOD_FSC)) {
